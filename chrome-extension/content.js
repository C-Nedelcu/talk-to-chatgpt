...
// Hide / Show ElevenLabs API KEY
var CN_TTS_ELEVENLABS_APIKEY_HIDDEN = true;
...
const buttonActions = {
    ...
    micon: function () {
        toggleMicrophone(this, 'micoff', true);
    },
    micoff: function () {
        toggleMicrophone(this, 'micon', false);
    },
    speakon: function () {
        toggleSpeaking(this, 'speakoff', true);
    },
    speakoff: function () {
        toggleSpeaking(this, 'speakon', false);
    },
    skip: skipMessage
};
...
function CN_InitScript() {
    ...
    jQuery("body").append(
        ...
        "<div style='text-align: right; font-size: 11px; color: grey'>V2.8.2</div>" +
        "</a>" +
        "</div>" +
...
function CN_OnSettingsIconClick() {
    ...
    rows += "<tr class='CNElevenLabs' style='display: none;'><td style='white-space: nowrap'>ElevenLabs API Key:</td><td><input type='password' style='width: 250px; padding: 2px; color: black;' id='TTGPTElevenLabsKey' value=\"" + (CN_TTS_ELEVENLABS_APIKEY) + "\" /><div><input style='margin: 5px 1px;' id='TTGPTElevenLabsKeyVisibility' type='checkbox' /><span style='display: inline-block; margin-left: 5px;'>Hide API-KEY</span></div></td></tr>";
...
function CN_SaveSettings() {
    ...
    try {
        ...
        CN_TTS_ELEVENLABS_APIKEY_HIDDEN = jQuery("#TTGPTElevenLabsKeyVisibility").prop("checked");
