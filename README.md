...
Version 2.8.2 - ???
* Updated: ElevenLabs API Key field now auto hides secret. Added button to show / hide api key 
* Updated: Settings page visually improved, added close page on escape button pressed for convenience
